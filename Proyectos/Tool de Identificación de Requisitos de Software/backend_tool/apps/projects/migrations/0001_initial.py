# Generated by Django 2.2.3 on 2020-07-20 06:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation', models.BooleanField(blank=True, null=True, verbose_name='confimacion')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='project',
            name='users',
            field=models.ManyToManyField(related_name='projects', through='projects.UserProject', to=settings.AUTH_USER_MODEL),
        ),
    ]
